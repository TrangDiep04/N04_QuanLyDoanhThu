...
public class ProductQueries {
    ...
    public static final String CREATE_NEW_PRODUCT =
            "INSERT INTO products (product_code, name, description, price, stock_quantity, specifications, image_url) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public static final String UPDATE_PRODUCT = "UPDATE products SET product_code = ?, name = ?, " +
            "description = ?, price = ?, stock_quantity = ?, specifications = ?, image_url = ? WHERE id = ?";
